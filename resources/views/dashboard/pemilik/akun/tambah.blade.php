        ...
        <div class="col-md-10 mx-auto">
            <div class="mx-auto max-w-screen-xl px-4 py-2 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-lg text-center">
                    <h1 class="text-2xl font-bold sm:text-3xl">Tambahkan Akun Baru</h1>
                </div>

                <form action="{{ route('dashboard.pemilik.akun.tambah.submit') }}" method="POST" class="mx-auto mt-8 max-w-md space-y-4">
                    @csrf
                    ...
                    <div class="flex items-center justify-between space-x-4">
                        <a href="{{ route('dashboard.pemilik.akun') }}" class="inline-block text-center rounded-lg bg-gray-200 px-5 py-3 text-sm font-medium text-gray-700 flex-1">
                            Batal
                        </a>
                        <button 
                            type="submit" 
