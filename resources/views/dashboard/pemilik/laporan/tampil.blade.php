...
<div class="container-fluid mt-4 px-4">
    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            <h2 class="text-4xl font-extrabold dark:text-white">Laporan Pemilik</h2>
        </div>
    </div>
        ...
        <div class="dropdown-container grid grid-cols-1 md:grid-cols-4 gap-2 mt-4 items-end">
            ...
            <div>
                ...
                <select id="jenisLaporan" name="jenis_laporan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <option value="seluruh_laporan">Seluruh  Laporan</option>
                </select>
            </div>
            ...
            <!-- Tombol Unduh -->
            <div class="flex ml-2">
                <a href="#" id="downloadButton" class="btn bg-blue-500 w-full md:w-auto text-center ml-auto text-white" disabled>Unduh PDF</a>
            </div>
        </div>
    </form>
...
function updatePreviewAndDownload() {
    ...
    if (jenisLaporan && bulanLaporan && tahunLaporan) {
        ...
        iframe.src = `/dashboard/pemilik/laporan/preview?jenis_laporan=${jenisLaporan}&bulan_laporan=${bulanLaporan}&tahun_laporan=${tahunLaporan}`;

        // Update href tombol unduh
        downloadButton.href = `/dashboard/pemilik/laporan/unduh?jenis_laporan=${jenisLaporan}&bulan_laporan=${bulanLaporan}&tahun_laporan=${tahunLaporan}`;
