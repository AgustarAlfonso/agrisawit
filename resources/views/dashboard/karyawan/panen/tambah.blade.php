        ...
        <div class="col-md-10 mx-auto"> <!-- Centered content -->
            ...
            <div class="mx-auto max-w-screen-xl px-4 py-2 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-lg text-center">
                    <h1 class="text-2xl font-bold sm:text-3xl">Tambahkan Data Panen</h1>
                </div>

                <form action="{{ route('dashboard.karyawan.panen.tambah.submit') }}" method="POST" class="mx-auto mt-8 max-w-md space-y-4">
                    @csrf
